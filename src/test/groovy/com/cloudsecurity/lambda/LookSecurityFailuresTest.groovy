...
class LookSecurityFailuresTest extends Specification {

//	def "should equal"() {
//
//		SNSEvent event = new SNSEvent()
//		Context context = Mock()
//		context.invokedFunctionArn >> "arn:aws:lambda:us-east-1:864374811737:function:aws-groovy-gradle-serverless-dev-echosns"
...
//	}
	...
	LookSecurityFailures lambda = new LookSecurityFailures()
...
"""
	...
	//def message1 = """{[{sns: {messageAttributes: {},signingCertUrl: https://sns.us-east-1.amazonaws.com/SimpleNotificationService-433026a4050d206028891664da859041.pem,messageId: 5cf3f6e5-cc28-52df-bad0-a5a976453454,message: {"s3Bucket":"jcazure2-write-only","s3ObjectKey":["AWSLogs/864374811737/CloudTrail/us-east-1/2018/04/16/864374811737_CloudTrail_us-east-1_20180416T2125Z_yZpaOh1piChHyQpy.json.gz"]},unsubscribeUrl: https://sns.us-east-1.amazonaws.com/?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:us-east-1:864374811737:write-only:b64a5d1b-5535-4ee5-87fa-bc650cc56a0c,type: Notification,signatureVersion: 1,signature: ,timestamp: 2018-04-15T02:25:49.393Z,topicArn: arn:aws:sns:us-east-1:864374811737:write-only},eventVersion: 1.0,eventSource: aws:sns,eventSubscriptionArn: arn:aws:sns:us-east-1:864374811737:write-only:b64a5d1b-5535-4ee5-87fa-bc650cc56a0c}]}"""
